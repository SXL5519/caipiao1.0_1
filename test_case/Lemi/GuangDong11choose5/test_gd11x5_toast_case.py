...
##广东11选5 toast提示信息验证测试用例  ----mj20171102
class GD11x5ToastCase(MyTest):
    def test_dantuo_front3_choose_out_case(self):
        '''广东11选5胆拖玩法，前三组选玩法，3个胆码，提示“胆码个数超过限制”流程测试'''
    ...
    def test_dantuo_front2_choose_out_case(self):
        '''广东11选5胆拖玩法，前二组选玩法，2个胆码，提示“胆码个数超过限制”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_dantuo_option7_choose_out_case(self):
        '''广东11选5胆拖玩法，任选七玩法，7个胆码，提示“胆码个数超过限制”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_dantuo_option6_choose_out_case(self):
        '''广东11选5胆拖玩法，任选六玩法，6个胆码，提示“胆码个数超过限制”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_dantuo_option5_choose_out_case(self):
        '''广东11选5胆拖玩法，任选五玩法，5个胆码，提示“胆码个数超过限制”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_dantuo_option3_choose_out_case(self):
        '''广东11选5胆拖玩法，任选三玩法，3个胆码，提示“胆码个数超过限制”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_dantuo_option2_choose_out_case(self):
        '''广东11选5胆拖玩法，任选二玩法，2个胆码，提示“胆码个数超过限制”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_option15_choose_out_case(self):
        '''广东11选5普通玩法，乐选五玩法，选取6个号码，提示“只支持单式投注”流程测试'''
        hp = HomePage(self.driver)
        hp.open()
        ulcn = UnionLottoChooseNumber(self.driver)
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
        ...
        efcn.countdown_text()  # 检查“距离第xxx期截止：”文案是否存在
        efcn.spread_mode_button()  ##选择展开玩法
        efcn.mode_choose(23 ,15  )  # 选择广东11选5普通模式乐选五玩法
