...
from  element_operate.RX9C.rx9c_choosenumber import RX9C_choosenumber_lexiu
from time import sleep
from element_operate.UnionLotto.confirm_lottery import ConfirmLottery_lexiu
from  element_operate.RX9C.rx9c_confirmlottery import RX9C_ConfirmLottery_lexiu
...
class rx9c_case(MyTest):
    ...
    def test_choosenumber_case(self):
        ...
        hb=RX9C_choosenumber_lexiu(self.driver)
        hc = RX9C_ConfirmLottery_lexiu(self.driver)
        hc1=ConfirmLottery_lexiu(self.driver)
    ...
    def test_nine_one_times_case(self):
        ...
        hc = RX9C_ConfirmLottery_lexiu(self.driver)
        hc1 = ConfirmLottery_lexiu(self.driver)
        hc2 = ArrangeFiveConfirmLottery_lexiu(self.driver)
        hl = Login_lexiu(self.driver)
        hd = LessPaySucess_lexiu(self.driver)
        ha.open()
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
    ...
    def test_seven_color_Del_all_nu_cancel_case(self):
        ...
        hc2 = RX9C_ConfirmLottery_lexiu(self.driver)
        ha.open()
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
        ha.Moveable_float_close()
        ha.optional_9_link()  # 点击任选9场
    ...
    def test_seven_color_Del_all_nu_ok_case(self):
        ...
        hc = ConfirmLottery_lexiu(self.driver)
        hc1 = PaintBallConfirm_lexiu(self.driver)
        hc2 = PaintBallChooseNumber_lexiu(self.driver)
        ha.open()
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
        ha.Moveable_float_close()
        ha.optional_9_link()  # 点击任选9场
