...
from element_operate.historical_trend import HistoricalTrend_lexiu
from element_operate.homepage import HomePage_lexiu
from element_operate.login import Login_lexiu
from test_case.Base.mytest import MyTest


###山东11选5机选玩法测试---mj171101
class sdElevenChooseFiveCase(MyTest):
    '''山东11选5测试'''
