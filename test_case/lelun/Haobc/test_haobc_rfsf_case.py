...
#####竞彩篮球让分胜负玩法测试用例###----mj20171116
class Haobc_rfsf_Case(MyTest):
    '''竞彩篮球让分胜负玩法流程测试'''
    ...
    def test_haobc_rfsf_throw10_case(self):
        '''选择投10倍流程测试'''
        hp = HomePage_lelun(self.driver)
        hcn = HaobcChooseNumber_lelun(self.driver)
        cl = ConfirmLottery_lelun(self.driver)
    ...
    def test_haobc_rfsf_throw50_case(self):
        '''选择投50倍流程测试'''
        hp = HomePage_lelun(self.driver)
        hcn = HaobcChooseNumber_lelun(self.driver)
        cl = ConfirmLottery_lelun(self.driver)
    ...
    def test_haobc_rfsf_throw80_case(self):
        '''选择投80倍流程测试'''
        hp = HomePage_lelun(self.driver)
        hcn = HaobcChooseNumber_lelun(self.driver)
        cl = ConfirmLottery_lelun(self.driver)
    ...
    def test_haobc_rfsf_throw_add_btn_case(self):
        '''点击投注倍数的+按钮流程测试'''
        hp = HomePage_lelun(self.driver)
        hcn = HaobcChooseNumber_lelun(self.driver)
        cl = ConfirmLottery_lelun(self.driver)
