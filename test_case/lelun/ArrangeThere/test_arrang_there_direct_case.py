...
from element_operate.Seven_color.Seven_color_choosenumber import Seven_color_choosenumber_lelun
...
###########直选######################
    ...
    def test_Direct_Coun_nu_case(self):
        ...
        hb=Arrang_there_choosenumber_lelun(self.driver)
        hb1=ArrangeFiveChooseNumber_lelun(self.driver)
        hb2 = ArrangeFiveConfirmLottery_lelun(self.driver)
        hc = ConfirmLottery_lelun(self.driver)
        hd = ArrangeFiveConfirmLottery_lelun(self.driver)
        hl = Login_lelun(self.driver)
        ha.open()
    ...
    def test_arrany_there_play(self):
        ...
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = There_D_choosenumber_lelun(self.driver)
        hb2 = ArrangeFiveChooseNumber_lelun(self.driver)
        ha.open()
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
        ha.Moveable_float_close()
    ...
    def test_a_note_a_double_case(self):
        """1注1倍"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
    ...
    def test_a_note_a_double_Continue_case(self):
        """1注1倍,继续选号"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
        ...
        hc.submit_order_to_station_owner_button()  # 点击提交给站主
        hc.confirm_and_pay_button()  # 点击确认支付
        mur3 = hd.assect_pay()  ##读取支付状态文本
        self.assertEqual('订单提交成功', mur3)
    ...
    def test_a_note_a_double_Continue_after_case(self):
        """1注1倍,继续选号,复式"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
    ...
    '''def test_a_note_a_double_pause_one_case(self):
        """1注1倍,机选一注"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
    ...
    def test_a_note_a_double_pause_five_case(self):
        """1注1倍,机选五注"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
    ...
    '''def test_a_note_a_double_pause_one_period_case(self):
        """1注1倍,机选一注,追期"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
    ...
    def test_a_note_a_double_pause_five_period_case(self):
        """1注1倍,机选五注,追期"""
        ha = HomePage_lelun(self.driver)
        hb = Arrang_there_choosenumber_lelun(self.driver)
        hb1 = UnionLottoChooseNumber_lelun(self.driver)
