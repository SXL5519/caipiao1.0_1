...
from element_operate.SingleBasketball.single_basketball_choosenumber import SingleBasketballChooseNumber_leyou
...
#####竞篮单关大小分玩法测试用例###----mj20171123
class single_basketball_dxf_Case(MyTest):
    '''竞篮单关大小分玩法流程测试'''
    def test_single_basketball_dxf_1_case(self):
        '''选择一场比赛流程测试'''
        ###点击进入竞篮单关选号页面###
    ...
    def test_single_basketball_dxf_8_case(self):
        '''选择8场比赛，流程测试'''
        ###点击进入双色球选号页面###
        hp=HomePage_leyou(self.driver)
        hcn=HaobcChooseNumber_leyou(self.driver)
    ...
    def test_single_basketball_dxf_10_case(self):
        '''选择一天中所有比赛场次流程测试'''
        ###点击进入双色球选号页面###
        hp=HomePage_leyou(self.driver)
        hcn = HaobcChooseNumber_leyou(self.driver)
    ...
    def test_single_basketball_dxf_click_all(self):
        '''点击页面展示所有比赛，测试流程'''
        hp = HomePage_leyou(self.driver)
        hcn = HaobcChooseNumber_leyou(self.driver)
        sbcn = SingleBasketballChooseNumber_leyou(self.driver)
    ...
    def test_single_basketball_dxf_throw_add_btn_case(self):
        '''点击投注倍数的+按钮流程测试'''
        hp = HomePage_leyou(self.driver)
        hcn = HaobcChooseNumber_leyou(self.driver)
        sbcn = SingleBasketballChooseNumber_leyou(self.driver)
    ...
    def test_single_basketball_dxf_throw_sub_btn_case(self):
        '''点击投注倍数的-按钮流程测试'''
        hp = HomePage_leyou(self.driver)
        hcn = HaobcChooseNumber_leyou(self.driver)
        sbcn = SingleBasketballChooseNumber_leyou(self.driver)
    ...
    def test_single_basketball_dxf_edit_event_case(self):
        ...
        if aa == 2:
            ...
            if bb == 0:#只有一场的时候
                print("我已进入竞足单关")
    def test_single_basketball_dxf_delete_one_event_case(self):
        """验证单个删除赛事X按钮，流程测试"""
        hp = HomePage_leyou(self.driver)
        hcn = HaobcChooseNumber_leyou(self.driver)
        sbcn = SingleBasketballChooseNumber_leyou(self.driver)
    ...
    def test_single_basketball_dxf_delete_all_event_case(self):
        """验证删除选择的全部赛事图标，流程测试"""
        hp = HomePage_leyou(self.driver)
        hcn = HaobcChooseNumber_leyou(self.driver)
        sbcn = SingleBasketballChooseNumber_leyou(self.driver)
