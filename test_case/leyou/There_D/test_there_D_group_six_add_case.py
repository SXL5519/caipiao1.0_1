...
class there_D_group_six_case(MyTest):
    ...
    def test_group_six_add_pause_one_case(self):
        """验证选号页面，点击机选按钮功能"""
        ha = HomePage_leyou(self.driver)
        hb = There_D_choosenumber_leyou(self.driver)
        hb1 = ArrangeFiveChooseNumber_leyou(self.driver)
    ...
    def test_group_six_add_many_note_many_double_case(self):
        """手动选择多注多倍号码"""
        ha = HomePage_leyou(self.driver)
        hb = There_D_choosenumber_leyou(self.driver)
        hb1 = ArrangeFiveChooseNumber_leyou(self.driver)
    ...
    def test_group_six_add_many_note_many_double_Coun_nu_case(self):
        """验证多注多倍号码，点击继续选号按钮功能"""
        ha = HomePage_leyou(self.driver)
        hb = There_D_choosenumber_leyou(self.driver)
        hb1 = ArrangeFiveChooseNumber_leyou(self.driver)
    ...
    def test_group_six_add_a_note_Del_none_case(self):
        """验证确认投注页面，点击X图标功能"""
        ha = HomePage_leyou(self.driver)
        hb = There_D_choosenumber_leyou(self.driver)
        hb1 = ArrangeFiveChooseNumber_leyou(self.driver)
    ...
    '''def test_group_six_add_Del_all_nu_cancel_case(self):
        """验证确认投注页面，点击删除选号图标功能"""
        ha = HomePage_leyou(self.driver)
        hb = There_D_choosenumber_leyou(self.driver)
        hb1 = ArrangeFiveChooseNumber_leyou(self.driver)
