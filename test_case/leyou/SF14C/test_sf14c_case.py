...
from  element_operate.RX9C.rx9c_choosenumber import RX9C_choosenumber_leyou
from time import sleep
from element_operate.UnionLotto.confirm_lottery import ConfirmLottery_leyou
from  element_operate.RX9C.rx9c_confirmlottery import RX9C_ConfirmLottery_leyou
...
class SF14C_case(MyTest):
    ...
    def test_Play_instruction_case(self):
        ...
        ha = HomePage_leyou(self.driver)
        hb = RX9C_choosenumber_leyou(self.driver)
        hb1=Arrang_there_choosenumber_leyou(self.driver)
    ...
    def test_seven_color_Del_all_nu_ok_case(self):
        ...
        hc2 = PaintBallChooseNumber_leyou(self.driver)
        ha.open()
        ######判断是否出现浮层弹框，如果出现浮层点击X，然后执行下一步操作
        ha.Moveable_float_close()
        ha.victory_defeat_14_link()  # 点击胜负14场
